def black_jack():
  ...
  while True:
    if check_bust(player_card_total) and ((11 in player[0]) or (11 in player[1]) or (11 in player[2])) and uses == 0:
  ...
  while dealer_card_total < 17 and player_card_total < 21:
    ...
    dealer_card_total += dealer[-1][0]
    if dealer_card_total > 21 and ((11 in dealer[0]) or (11 in dealer[1])) and uses == 0 :
  ...
  if player_card_total < dealer_card_total and (not check_bust(dealer_card_total)) or check_bust(player_card_total):
    return False
  elif player_card_total > dealer_card_total and (not check_bust(player_card_total)) or check_bust(dealer_card_total):
    return True
